...
class HomePostCell: UICollectionViewCell {
    ...
    let captionLabel: UILabel = {
        ...
        attributedText.append(NSAttributedString(string: " this is a caption that might be so long and wrap to the next line.", attributes: [NSAttributedStringKey.font: UIFont.systemFont(ofSize: 14)]))
        
        attributedText.append(NSAttributedString(string: "\n\n", attributes: [NSAttributedStringKey.font: UIFont.systemFont(ofSize: 4)]))
        
        attributedText.append(NSAttributedString(string: "\n1 week ago", attributes: [NSAttributedStringKey.font: UIFont.systemFont(ofSize: 13), NSAttributedStringKey.foregroundColor: UIColor.gray]))
